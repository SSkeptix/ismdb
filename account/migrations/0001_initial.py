    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(choices=[(1, 'Student'), (2, 'Teacher'), (3, 'Employer')], default=1)),
            ],
            options={
                'verbose_name': 'user',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('english', models.IntegerField(choices=[(1, 'A1 - Elementary'), (2, 'A2 - Pre-Intermediate'), (3, 'B1 - Intermediate'), (4, 'B2 - Upper intermediate'), (5, 'C1 - Advanced'), (6, 'C2 - Proficient')], default=1)),
        ...
        migrations.AlterUniqueTogether(
            name='framework',
            unique_together=set([('value', 'lang')]),
        ),
        migrations.AlterUniqueTogether(
            name='studentother',
